...
class SteadReader:
    ...
    def prepare_datasets_case_three(self):
        keys_learn = []
        keys_test = []
        ...
        with h5py.File(self._cfg["stead_learn_stft_64"], "a") as f:
            f.create_dataset("keys", shape=(len_keys_learn,), dtype="S50")
            f.create_dataset(
                "data", shape=(len_keys_learn, 64, 64, 3), dtype="float32"
            )
            f.create_dataset("labels", shape=(len_keys_learn,), dtype="i4")
        ...
        with h5py.File(self._cfg["stead_test_stft_64"], "a") as f:
            f.create_dataset("keys", shape=(len_keys_test,), dtype="S50")
            f.create_dataset(
                "data", shape=(len_keys_test, 64, 64, 3), dtype="float32"
            )
            f.create_dataset("labels", shape=(len_keys_test,), dtype="i4")
